	...
	<div class="content-wrap">
		...
		<main class="main-cont content mCustomScrollbar">
			<div class="page-wrap">
				...
				<table id="tablelist" class="table mb-15">
			        ...
			        %>
						<tr class="cen">
							...
							<% scores[num] = Float.parseFloat(rs.getString("score"));
			                   num++;
			                %>
							<td>
								<a title="编辑" onclick="editScoreTable(this)" class="mr-5">编辑</a>
								<a title="删除" onclick="deleteScoreTable(this)">删除</a>
							</td>
						</tr>
				      <%
			           }
				...
				<h4>成绩统计</h4>&nbsp;&nbsp;&nbsp;&nbsp;
				最高分:&nbsp;<%=FloatValue.getMaxValue(scores, num)%>&nbsp;&nbsp;
		                    最低分:&nbsp;<%=FloatValue.getMinValue(scores, num)%>&nbsp;&nbsp;
		                    平均分:&nbsp;<%=FloatValue.getAvgValue(scores, num)%>
		                    
		         <!-- 添加新增信息模块 -->
				<br/>
				<br/>
				<div class="contact-form contact">
				    <input type="button" value="新增" id="newScore" class="submit btn btn-default">
				    <!-- 编辑表格和新建都是这个表格 -->
				    <div style="display:none;" id="newScoreTable" class="form-group has-feedback">
				    <table id="addTable" class="table mb-15">
				      ...
				      <tr class="cen">
							<td><input style="width:150px;" type="text" class="form-control"></td>
							<td><input style="width:150px;" type="text" class="form-control"></td>
							<td><input style="width:150px;" type="text" class="form-control"></td>
							<td>
								<input type="button" value="提交" id="submitScore" class="submit btn btn-default">
							</td>
						</tr>
				    </table>
