...
<%@ page import="database.SelectDB, utils.CharsetSwitch, java.util.ArrayList, javax.servlet.http.HttpSession, java.sql.ResultSet, chat.MessagePush, chat.TeacherSend, utils.FloatValue"%>
            ...
            <div class="chatRight">
                <div class="chat03">
                    <div class="chat03_title">
                        <label class="chat03_title_t">孩子的老师</label>
                    </div>
