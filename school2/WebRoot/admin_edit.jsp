		...
		<main class="main-cont content mCustomScrollbar">
			<div class="page-wrap">
			 ...
			 <div class="panel panel-default">
				...
				<div style="width:300px;" class="form-group has-feedback">
						     <label for="name">输入新闻的保存html文件名称</label>
						     <input  id="filename" type="text" class="form-control" name="name" placeholder="">
				             <label for="name">输入新闻的标题</label>
						     <input  id="newstitle" type="text" class="form-control" name="name" placeholder="">
				</div>					
		       <input type="button" value="提交新闻" id="newsSubmit" class="submit btn btn-default">
		        <input type="button" value="修改新闻" id="newsUpdate" class="submit btn btn-default">
		         <input type="button" value="删除新闻" id="newsDelete" class="submit btn btn-default">
		         <br/>
		         <br/>
		         <br/>
		         </div>
