		...
		<main class="main-cont content mCustomScrollbar">
			<div class="page-wrap">
				...
				<table id="tablelist" class="table mb-15">
			        ...
			        %>
						<tr class="cen">
							...
							<td>
								<a title="编辑" onclick="editParentTable(this)" class="mr-5">编辑</a>
								<a title="删除" onclick="deleteParentTable(this)">删除</a>
							</td>
						</tr>
				      <%
			           }
				...
				<div class="contact-form contact">
				    <input type="button" value="新增" id="newParent" class="submit btn btn-default">
				    <!-- 编辑表格和新建都是这个表格 -->
				    <div style="display:none;" id="newParentTable" class="form-group has-feedback">
				    <table id="addTable" class="table mb-15">
				      ...
				      <tr class="cen">
							...
							<td><input style="width:200px;" type="text" class="form-control"></td>
							<td>
								<input type="button" value="提交" id="submitParent" class="submit btn btn-default">
							</td>
						</tr>
				    </table>
